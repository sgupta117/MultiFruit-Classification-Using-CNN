...
fruit_model = model.fit(train_gen, epochs=5, batch_size = 165,validation_data=val_gen, verbose=1)
...
model.save("/content/drive/My Drive/Fruits Image Classification/fruit_new.h5")
